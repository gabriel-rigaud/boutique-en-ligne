...
//--------------------Affiche les articles suivant la catéorie choisie
    if(isset($_GET["categorie"]) && !empty($_GET["categorie"]) && !empty($categories))
        {                                    
            ...
            ?>
            <h1 class="titre-boutique"><?= $titre_cat["nom"]?></h1>
            <?php
                    ...
                    foreach($categorie_articles as $article => $element)
                        {
                            ...
                            <section class="articles">
                                ...
                                <section class="infos_articles">
                                    <section>
                                        <a href="article.php?id=<?= $element["id"] ?>&p=1"><img ondragstart="return false;" src="php/traitement/upload/<?= $element["image"] ?>" alt="photo article" class="image-boutique"></a>
                                    </section>
                                    <section class="lecture_articles">
                                        <section class="texte_aticles">
                                            <p>"<?= substr($element["article"], 0, 200) ?>..."</p><!-- Limiter le nombre de caractère -->
                                            <br><h1 class="prix"><?= $element['prix'] ?>€</h1>
                                        </section>
                            ...
                            ?>
                             <section class="pagination"> 
                                ...
                                if($page > 1)
                                    {
                                        ?>
                                        <a href="articles.php?start=<?= $page - 1 ?>&categorie=<?= $element['id_categorie'] ?>&par_page=<?= $par_page ?>" class="btn btn-primary"><i class="fa-sharp fa-solid fa-arrow-left"></i></a>
                                        <?php
                                    }    
                                else
                                    {
                                ...
                                if($page < $nb_pages_cat)
                                    {
                                        ?>
                                        <a href="articles.php?&start=<?= $page + 1 ?>&categorie=<?= $element['id_categorie'] ?>&par_page=<?= $par_page ?>" class="par_suivant"><i class="fa-sharp fa-solid fa-arrow-right"></i></a>
                                        <?php
                                    }
                            ?>
                            </section> 
                    ...
                    if($nb_articles>$par_page)
                        {
                            ...
                            <section class="pagination"> 
                                ...
                                if($page > 1)
                                    {
                                        ?>
                                        <a href="articles.php?start=<?= $page - 1 ?>&par_page=<?= $par_page ?>" class="par_avant"><i class="fa-sharp fa-solid fa-arrow-left"></i></a>
                                        <?php
                                    }    
                                else
                                    {
                                ...
                                if($page < $nb_pages)
                                    {
                                        ?>
                                        <a href="articles.php?&start=<?= $page + 1 ?>&par_page=<?= $par_page ?>" class="btn btn-primary suivant"><i class="fa-sharp fa-solid fa-arrow-right"></i></a>
                                        <?php
                                    }
                            ?>
                            </section> 
